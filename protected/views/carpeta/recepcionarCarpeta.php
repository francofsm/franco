...
<div class="pagina">
	...
	<div class="div-titulo">		
		<div class="titulo">Recepción de Carpeta</div><div class="subtitulo">Indica que la ubicación de la carpeta esta en tu oficina</div>
	</div>

	<div class="div-form-uno">
		<span class="label label-warning">Recepcionar en una Bodega y/o Casillero es alternativo (puedes dejarlo vacío)</span>
			...
			<div class="row-inline-normal">
				...
				<?php 
				foreach ($ubi as $ubi) { ?>
					<option value="<?php echo $ubi->cod_ubicacion; ?>"><?php echo $ubi->gls_ubicacion; ?></option><?php
				} 
				?>
				</select>
			</div>
			...
			<div class="row-inline-normal">
				...
				<input type="text" id="ruc" name="ruc" class="input-md required ruc" oninput="checkRut(this.value,this)"  maxlength="12" minlength="12" placeholder="Ingrese RUC" required="" />
			...
			<div style="margin-top: 8px;margin-bottom: 17px;">
				<button type="submit" class="btn btn-success" title="Agregar Registros">Recepcionar</button>
			</div>
			</center>
...
$('#fomover').submit(function() {
		...
		document.getElementById('loading').style.display= 'block';
		    	miurl = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=Carpeta/GuardarRecepcionCarpeta'?>";
		        $.ajax({
		            type: 'POST',
		            url: miurl,
		            data: $(this).serialize(),	 
