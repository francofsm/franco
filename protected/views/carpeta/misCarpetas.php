...
<div class="pagina">
	...
	<div class="div-titulo">		
		<div class="titulo">Listado Carpetas en mi Oficina</div><div class="subtitulo">Listado de carpetas recepcionadas</div>
	</div>
...
<script type="text/javascript">
	...
	var cod = $("#ubicacion").val(); 
  	...
  	$.ajax({
	    type: 'POST',
	    url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=Carpeta/ListarMisCarpetas&cod='?>"+cod,
