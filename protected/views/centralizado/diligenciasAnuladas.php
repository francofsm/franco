...
<div class="pagina">
	...
	<div class="div-titulo">		
		<div class="titulo">Listado de Diligencias Anuladas</div><div class="subtitulo"></div>
	</div>
...
<!--
	...
	<div class="row-inline-rev" style="margin-left: 100px;padding: 20px;border: 1px solid #d3ced2;">
		<label style="font-size: 18px;font-weight: 600;">Fecha Inicio<span class="required">*</span></label>
	...
	<div class="col-md-33">
	<div class="row-inline-rev" style="margin-left: 100px;padding: 20px;border: 1px solid #d3ced2;">
		<label style="font-size: 18px;font-weight: 600;">Fecha Fin<span class="required">*</span></label>
...
<script type="text/javascript">
	function consultar(e){
  	...
  	var fec_fin = $("#fin").change({ dateFormat: "yyyy/mm/dd" }).val()
	    ...
	    $.ajax({
		    type: 'POST',
		    url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=Centralizado/ListarDiligenciasAnuladas&fec='?>"+fec+'&fec_fin='+fec_fin,
