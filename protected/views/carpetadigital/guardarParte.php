...
<div class="pagina">
	...
	<div class="div-titulo">		
		<div class="titulo">Ingresar Parte Nuevo y Documentos asociados</div><div class="subtitulo"></div>
		<div class="subtitulo">Permite registrar un nuevo parte y sus documentos asociados.</div>
	</div>
	...
	<div class="col-md-5">
		...
		<div class="row-inline-medi">
	        <label  style="font-weight: bolder;font-size: 14px;">Parte Nuevo </label>
	        <input type="checkbox" name="nuevo" id="nuevo">	                

	        <label  style="font-weight: bolder;font-size: 14px;">Control</label>
	        <input type="checkbox" name="control" id="control">	                
	     </div>
	     <br><br>
		<div class="row-inline-medi">
	        <label  style="font-weight: bolder;font-size: 14px;">Prioritario</label>
	        <input type="checkbox" name="prior" id="prior">	                
	     </div>
	     <br><br>
    	...
    	<ol>
		  <li>Generar el ruc en <strong>SAF</strong> con el ingreso de la denuncia.</li>
		  ...
		  <li>Si corresponde a un parte nuevo, "checkear" parte nuevo. Si además es un control, "checkear" control</li>
...
<script type="text/javascript">
	 $("#formoid").submit(function(event) {
	 	...
	 	urlsave = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=CarpetaDigital/GuardarParteDigital'?>";
	 	$.ajax({
	        url: urlsave,
	        type: 'POST',
	        data: datastring,
