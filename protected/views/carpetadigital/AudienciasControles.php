...
<div class="pagina">
	...
	<div class="div-titulo">		
		<div class="titulo">Listado de Causas para Audiencia de Control de detención</div><div class="subtitulo">Desde RUC, es posible acceder a Ficha caso.</div>
	</div>
...
<script type="text/javascript">
 $("#formoid").submit(function(event) {
    	...
    	urlsave = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=CarpetaDigital/ListarCausaAudienciaControles'?>";
	...
	function adjuntarResultado(val, id) {
		...
		miurl = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=CarpetaDigital/UploadMinutaResultado&codigo='?>"+id
...
<!--- ACTUALIZACION ELIMINACION DE RESULTADOS DE AUDIENCIA   ---> 
		...
		$.ajax({
		      ...
		      success: function(data){  
		     	//	alert("hola resultado");
		            ...
		            urlver = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=CarpetaDigital/ListarCausaAudienciaControles'?>";
					$.ajax({
					    url: urlver,
					    type: 'POST',
