...
<div class="pagina">
	...
	<div class="col-md-12">
		<div style="border-bottom: 1px solid #dddddd;padding: 8px;">
 			<h4>Consultar Causa Digitalizada</h4>
 		</div>
	</div>
...
<script type="text/javascript">
	function descargarCarpetaSIAU(id){	
		...
		urldown = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=CarpetaDigital/DescargarCarpetaSIAU&ruc='?>"+id,
...
<script type="text/javascript">
	function reservarDoc(id){	
		...
		var r = confirm("Estas segur@ que deseas reservar el documento?");
		if (r == true) {
...
<script type="text/javascript">
	function elimDocumento(id){	

		var r = confirm("Estas SEGUR@ que deseas ELIMINAR el documento?");
		if (r == true) {
			urlreservar = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=CarpetaDigital/EliminarDocumento'?>";
			$.ajax({
			    url: urlreservar,
			    type: 'POST',
			    data: {id: id},
