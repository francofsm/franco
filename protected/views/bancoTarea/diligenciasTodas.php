...
<div class="pagina">
	...
	<div class="div-titulo">		
		<div class="titulo">Listado de TODAS las Diligencias Decretadas</div><div class="subtitulo"></div>
	</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		urltable = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=BancoTarea/ListarDiligenciasAsignadasTODAS&mes='?>"+mes,
