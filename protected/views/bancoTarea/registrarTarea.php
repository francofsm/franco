...
<div class="pagina">
	...
	<div class="div-titulo">		
		<div class="titulo">Decretar Diligencias/Tareas</div>
		<div class="subtitulo">
...
<script type="text/javascript">
	...
	urltable = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=BancoTarea/ListarTarea'?>";
	    $.ajax({
		    url: urltable,
		    type: 'POST',
		    success: function(result){  
...
<script type="text/javascript">
 $("#formoid").submit(function(event) {
    ...
    document.getElementById("error_msj").style.display = "none";
    	...
    	document.getElementById("loading").style.display = "block";
    	urlsave = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=BancoTarea/GuardarTarea'?>";
