...
<div class="pagina">
	...
	<div class="div-form-uno">
			...
			<div class="row-inline-normal">
				...
				<input type="text" id="ruc" name="rolunico"  maxlength="12" placeholder="Ingrese RUC" required="required" autofocus value="<?php if(isset($ruc_decreta)) echo $ruc_decreta; ?>" />
			</div>
			</center>
...
<script type="text/javascript">	
	$(document).ready(function() {
	   ...
	   miurl = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=BancoTarea/ConsultaDetalleCasoDigital'?>";
