...
<div class="pagina">
	...
	<div class="div-titulo">		
		<div class="titulo">Ejecutar Diligencias Asignadas</div><div class="subtitulo"></div>
	</div>
...
<script type="text/javascript">
	...
	urltable = "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=BancoTarea/ListarMisDiligencias'?>";
	    $.ajax({
		    url: urltable,
		    type: 'POST',
		    success: function(result){  
